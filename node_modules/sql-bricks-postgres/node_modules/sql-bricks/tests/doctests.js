    ...
    describe('SQL Bricks', function () {
        describe('documentation examples', function () {
            ...
            it("update('person', {'first_name': 'Fred'}).where({'last_name': 'Flintstone'}).toParams();", function () {
                check(update('person', {'first_name': 'Fred'}).where({'last_name': 'Flintstone'}).toParams(), {
                    "text": "UPDATE person SET first_name = $1 WHERE last_name = $2",
                    "values": ["Fred", "Flintstone"]
                });
            });

            it("update('person', {'first_name': 'Fred'}).where({'last_name': 'Flintstone'}).toParams({placeholder: '?%d'});", function () {
                check(update('person', {'first_name': 'Fred'}).where({'last_name': 'Flintstone'}).toParams({placeholder: '?%d'}), {
                    "text": "UPDATE person SET first_name = ?1 WHERE last_name = ?2",
                    "values": ["Fred", "Flintstone"]
                });
            });
            ...
            it("update('person', {'first_name': 'Fred'}).where({'last_name': 'Flintstone'}).toParams({placeholder: '?'});", function () {
                check(update('person', {'first_name': 'Fred'}).where({'last_name': 'Flintstone'}).toParams({placeholder: '?'}), {
                    "text": "UPDATE person SET first_name = ? WHERE last_name = ?",
                    "values": ["Fred", "Flintstone"]
                });
            });
            ...
            it("select('*').from('person').where({'last_name': 'Flintstone', 'first_name': 'Fred'});", function () {
                check(select('*').from('person').where({
            ...
            it("insertInto('person').values({'first_name': 'Fred', 'last_name': 'Flintstone'});", function () {
                ...
                check(insertInto('person').values({
                    'first_name': 'Fred',
                    'last_name': 'Flintstone'
                }), "INSERT INTO person (first_name, last_name) VALUES ('Fred', 'Flintstone')");
            });
            ...
            it("select().from('person').where(or({'first_name': 'Fred', 'last_name': 'Rubble'}));", function () {
                check(select().from('person').where(or({
                    'first_name': 'Fred',
                    'last_name': 'Rubble'
            ...
            it("sql(\"CASE WHEN level=1 THEN 'one' WHEN level=2 THEN 'two' ELSE 'other' END\")});", function () {
                ...
                check(select().from('person').where({
                    'level_text': sql("CASE WHEN level=1 THEN 'one' WHEN level=2 THEN 'two' ELSE 'other' END")
                }), "SELECT * FROM person WHERE level_text = CASE WHEN level=1 THEN 'one' WHEN level=2 THEN 'two' ELSE 'other' END");
            });
