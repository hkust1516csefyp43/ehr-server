(function () {
    ...
    if (is_common_js) {
        ...
        if (args[args.length - 1] == '--empty-extension') {
            console.log('tests configured with an empty extension');
            sql = sql._extension();
        }
    }
    ...
    describe('SQL Bricks', function () {
        describe('mini-templating lang', function () {
            ...
            it('should handle nested if', function () {
                var result = sql.templ('{{#if oneThing}} and {{#if anotherThing}}Test{{/if}}{{/if}}', {
                    'oneThing': true,
                    'anotherThing': true
                });
        ...
        describe('value handling', function () {
            ...
            describe('.toString() value conversions', function () {
                ...
                it('should support user-supplied conversions', function () {
                    ...
                    sql.conversions.Boolean = function (bool) {
                        return bool ? '1' : '0';
                    };
        ...
        describe('WHERE clauses', function () {
            ...
            it('should handle or([...])', function () {
                check(select().from('table').where({this: 'test'}).and(or(['test1', 'test2'].map(function (val) {
                        return eq('that', val);
                    }))),
