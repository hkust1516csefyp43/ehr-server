...
-- Reference:  Diagnose_history_Consultation (table: Diagnose_history)


ALTER TABLE Diagnose_history ADD CONSTRAINT Diagnose_history_Consultation 
...
-- Reference:  Diagnose_history_Diagnose (table: Diagnose_history)
...
-- Reference:  Diagnose_history_Patient (table: Diagnose_history)


ALTER TABLE Diagnose_history ADD CONSTRAINT Diagnose_history_Patient 
...
-- Reference:  Diagnose_history_Triage (table: Diagnose_history)


ALTER TABLE Diagnose_history ADD CONSTRAINT Diagnose_history_Triage 
