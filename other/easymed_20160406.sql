...
-- Last modification date: 2016-03-28 04:22:08.753
...
COMMENT ON COLUMN v2.consultation.preg_curr_preg IS 'no >> 0, 1 baby >> 1, twins >> 2';

COMMENT ON COLUMN v2.consultation.preg_gestration IS 'i.e. how many weeks';

-- Table: consultation_attachment
CREATE TABLE v2.consultation_attachment (
    ca_id text  NOT NULL,
    file_id text  NOT NULL,
    consultation_id text  NOT NULL,
    CONSTRAINT consultation_attachment_pk PRIMARY KEY (ca_id)
);


COMMENT ON TABLE v2.consultation_attachment IS 'i.e. photos and other stuff
e.g. skin condition';
...
CREATE TABLE v2.keywords (
    ...
    chief_complain boolean  NOT NULL DEFAULT false,
    ...
    relationship_type text  NOT NULL DEFAULT false,
...
-- Table: medication_variant
CREATE TABLE v2.medication_variant (
    ...
    name text  NOT NULL,
    remark text  NULL,
    CONSTRAINT medication_variant_pk PRIMARY KEY (medication_variant_id)
);



COMMENT ON COLUMN v2.medication_variant.stock IS '0 >> no
1 >> very little
2 >> (more than) enough';

COMMENT ON COLUMN v2.medication_variant.name IS 'I should''ve called it brand but i am too lazy to change it back';
...
-- foreign keys
-- Reference:  attachment_consultation (table: consultation_attachment)

ALTER TABLE v2.consultation_attachment ADD CONSTRAINT attachment_consultation 
    FOREIGN KEY (consultation_id)
    REFERENCES v2.consultation (consultation_id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE 
;

-- Reference:  attachment_files (table: consultation_attachment)

ALTER TABLE v2.consultation_attachment ADD CONSTRAINT attachment_files 
    FOREIGN KEY (file_id)
...
-- Reference:  consultation_users (table: consultation)

ALTER TABLE v2.consultation ADD CONSTRAINT consultation_users 
    FOREIGN KEY (user_id)
    REFERENCES v2.users (user_id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE 
...
-- Reference:  consultation_visits (table: consultation)

ALTER TABLE v2.consultation ADD CONSTRAINT consultation_visits 
    FOREIGN KEY (visit_id)
    REFERENCES v2.visits (visit_id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE 
...
-- Reference:  medication_users (table: medication)

ALTER TABLE v2.medication ADD CONSTRAINT medication_users 
    FOREIGN KEY (user_id)
    REFERENCES v2.users (user_id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE 
...
-- Reference:  medication_variant_medication (table: medication_variant)

ALTER TABLE v2.medication_variant ADD CONSTRAINT medication_variant_medication 
    FOREIGN KEY (medication_id)
    REFERENCES v2.medication (medication_id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE 
;

-- Reference:  medication_variant_suitcases (table: medication_variant)

ALTER TABLE v2.medication_variant ADD CONSTRAINT medication_variant_suitcases 
...
-- Reference:  medication_variant_users (table: medication_variant)

ALTER TABLE v2.medication_variant ADD CONSTRAINT medication_variant_users 
    FOREIGN KEY (user_id)
    REFERENCES v2.users (user_id)
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE 
